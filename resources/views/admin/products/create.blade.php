...
@section('content')
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Product Sub Image 1:</strong>
                    <input type="file" name="sub_image_2" class="form-control">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Product Sub Image 2:</strong>
                    <input type="file" name="sub_image_1" class="form-control">
                </div>
            </div>
