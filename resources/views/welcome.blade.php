                            ...
                            <div class="cart-hover">
                                <div class="select-items">
                                    <table>
                                        <tbody>
                                        <tr>
                                            <td class="si-pic"><img src="{{asset('store/img/select-product-1.jpg')}}" alt=""></td>
                                            <td class="si-text">
                                        ...
                                        <tr>
                                            <td class="si-pic"><img src="{{asset('store/img/select-product-2.jpg')}}" alt=""></td>
                                            <td class="si-text">
                                                <div class="product-selected">
                                                    <p>$60.00 x 1</p>
                                                    <h6>Kabino Bedside Table</h6>
            ...
            <div class="col-lg-8 offset-lg-1">
                ...
                <div class="product-slider owl-carousel">
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{asset('store/img/products/women-1.jpg')}}" alt="">
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{asset('store/img/products/women-2.jpg')}}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{asset('store/img/products/women-3.jpg')}}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{asset('store/img/products/women-4.jpg')}}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="product-slider owl-carousel">
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{asset('store/img/products/man-2.jpg')}}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{asset('store/img/products/man-3.jpg')}}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                            <img src="{{asset('store/img/products/man-4.jpg')}}" alt="">
                            <div class="icon">
                                <i class="icon_heart_alt"></i>
                            </div>
                            <ul>
